...
function Organizer() {
  ...
  return (
    <div   class="organizers" >
        <h2 style={{ backgroundColor : dark ? "#1a1a1a" : "", color: dark ? "white" : "#29153d"  }} className="mt-5 mb-5 fs-1" >Organizers</h2>
        <div class="row">
        {
            dataMemeber.map(i=>
                    <div key={i.id} style={{ height: "20rem" }} class= "bg-denger text-center col-lg-3 col-xl-3 col-md-12 col-sm-12">
                        ...
                        <div style={{ backgroundColor : dark ? "#1a1a1a" : "", color: dark ? "white" : "rgb(95, 99, 104)", fontSize:"16px"  }} >{i.position}</div>
                        <div class="mt-4"><Link class="fw-bolder ">View Profil</Link></div>
                    </div>
                )
        }
        </div>
        <h1 style={{ backgroundColor : dark ? "#1a1a1a" : "", color: dark ? "white" :"#29153d", margin:"3rem 0" }} >Chapter Video</h1>
